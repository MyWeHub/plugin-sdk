...
var file_workflow_folder_proto_goTypes = []any{
...
func file_workflow_folder_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_workflow_folder_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_workflow_folder_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_workflow_folder_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_workflow_folder_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Folder); i {
			case 0:
				return &v.state
			case 1:

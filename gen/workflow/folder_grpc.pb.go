...
func (c *folderServiceClient) CreateFolder(ctx context.Context, in *Folder, opts ...grpc.CallOption) (*Folder, error) {
	out := new(Folder)
	err := c.cc.Invoke(ctx, "/workflow.FolderService/CreateFolder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *folderServiceClient) SaveFolder(ctx context.Context, in *Folder, opts ...grpc.CallOption) (*Folder, error) {
	out := new(Folder)
	err := c.cc.Invoke(ctx, "/workflow.FolderService/SaveFolder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *folderServiceClient) FolderByID(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*Folder, error) {
	out := new(Folder)
	err := c.cc.Invoke(ctx, "/workflow.FolderService/FolderByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *folderServiceClient) RemoveFolder(ctx context.Context, in *RemoveFolderRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/workflow.FolderService/RemoveFolder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *folderServiceClient) MoveFolder(ctx context.Context, in *MoveFolderRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/workflow.FolderService/MoveFolder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *folderServiceClient) ListFolders(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListFolderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/workflow.FolderService/ListFolders", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *folderServiceClient) EditFolder(ctx context.Context, in *Folder, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/workflow.FolderService/EditFolder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FolderService_CreateFolder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/workflow.FolderService/CreateFolder",
	}
...
func _FolderService_SaveFolder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/workflow.FolderService/SaveFolder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FolderService_FolderByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/workflow.FolderService/FolderByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FolderService_RemoveFolder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/workflow.FolderService/RemoveFolder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FolderService_MoveFolder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/workflow.FolderService/MoveFolder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FolderService_ListFolders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/workflow.FolderService/ListFolders",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FolderService_EditFolder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/workflow.FolderService/EditFolder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

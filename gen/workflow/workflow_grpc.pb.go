...
type WorkflowServiceClient interface {
	...
	ListWorkflowsByClientID(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*WorkflowsResponse, error)
...
func (c *workflowServiceClient) ListWorkflowsByClientID(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*WorkflowsResponse, error) {
	out := new(WorkflowsResponse)
	err := c.cc.Invoke(ctx, "/workflow.WorkflowService/ListWorkflowsByClientID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WorkflowServiceServer interface {
	...
	ListWorkflowsByClientID(context.Context, *IdRequest) (*WorkflowsResponse, error)
...
func (UnimplementedWorkflowServiceServer) ListWorkflowsByClientID(context.Context, *IdRequest) (*WorkflowsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListWorkflowsByClientID not implemented")
}
...
func _WorkflowService_ListWorkflowsByClientID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkflowServiceServer).ListWorkflowsByClientID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/workflow.WorkflowService/ListWorkflowsByClientID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServiceServer).ListWorkflowsByClientID(ctx, req.(*IdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WorkflowService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListWorkflowsByClientID",
			Handler:    _WorkflowService_ListWorkflowsByClientID_Handler,
		},
		{
